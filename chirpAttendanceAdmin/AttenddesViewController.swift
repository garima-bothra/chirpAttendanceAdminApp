//
//  AttenddesViewController.swift
//  chirpAttendanceAdmin
//
//  Created by Garima Bothra on 13/12/19.
...
class AttenddesViewController: UIViewController,UITableViewDelegate,UITableViewDataSource{
